...
name: simple
description: >
  Te baja el estado de ESTA conversación en lenguaje simple y corto, separando
  "qué hacés vos" de "qué sigo yo". Usalo cuando perdiste el hilo o cuando la
  charla se hizo larga y querés ubicarte rápido. Frases gatillo: "bajámelo simple",
  "explicámelo simple", "¿dónde estamos?", "perdí el hilo", "resumime fácil",
  "no entiendo nada", "pará, ¿en qué estamos?".
---

# simple: ubicarte en una charla larga

Un tiro claro. Cuando una conversación se hizo larga o te perdiste el hilo, te bajo dónde estamos y qué sigue, en lenguaje simple y corto. **Es una sola vez, no un modo: te lo dejo claro y la charla sigue normal.**
...
Tirás una frase gatillo en una charla que ya viene avanzada. No toma parámetros. El contexto sale de la conversación, no de archivos.
...
- [ ] El bloque entra en ≤5 líneas.
- [ ] Separa explícitamente qué hace la persona y qué hago yo.
- [ ] Lenguaje simple, sin jerga sin traducir, cero em-dashes.
- [ ] Un solo tiro: entregué el estado y la charla siguió normal, sin quedar en un modo.
