...
name: transcribir
description: >
  Transcribe archivos de audio locales (.opus, .m4a, .mp3, .wav, .mp4, .ogg, .flac) con
  Whisper corriendo 100% en tu máquina. Gratis, sin mandar nada a la nube. Usalo cuando
  digas "transcribime este audio", "pasá este voice note a texto", "qué dice este audio",
  "transcribí la reunión grabada", o cuando pases un path a un archivo de audio sin más
  contexto. NO lo uses para audios de menos de 10 segundos que escribís más rápido a mano,
  ni para audio muy ruidoso o con dos idiomas mezclados al mismo tiempo.
---
