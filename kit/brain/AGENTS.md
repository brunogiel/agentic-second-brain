...
1. Leé `CLAUDE.md`, después `ESTADO.md` si existe.
...
4. Para diagnosticar progreso, usá la sección "🪜 Mi escalera" de `ESTADO.md`: ubicá el nivel actual, nombrá 1-2 cosas que ya están, y proponé un solo próximo paso.
5. Para activar un skill de uso, copiá `kit/skills/<nombre>/` a `skills/<nombre>/`, agregá su frase gatillo en la tabla "Mis skills" de `CLAUDE.md`, y tachalo en el catálogo "📦 Todo lo que trae el kit" de `ESTADO.md`.
