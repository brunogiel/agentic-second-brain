---
description: Convierte un tuit, un link, un artículo o un tema suelto en una lección: un solo HTML autocontenido para aprenderlo. Dos modos, a fondo o nivel cero.
---

Armá la lección sobre el disparador que venga en $ARGUMENTS (si no viene ninguno, pedilo). Seguí esto:
