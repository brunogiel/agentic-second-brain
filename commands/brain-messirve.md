---
description: Cruza lo que viste afuera (un tuit, un video, un repo, el skill de un amigo) contra lo que ya tenés: si ya lo tenés, qué le robás, y si no lo tenés y te sirve, lo agrega.
---

Pasá por el filtro lo que viene en $ARGUMENTS (el link, el archivo o lo que te peguen). Seguí esto:
